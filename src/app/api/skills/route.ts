...
import { getSkill, listSkillsFiltered } from "@/lib/agent/skills/registry";
...
/**
 * GET /api/skills
 * Query: q?, category?, id? (single skill with optional body)
 *
...
export async function GET(request: NextRequest) {
  ...
  const skills = await listSkillsFiltered({ q, category });
